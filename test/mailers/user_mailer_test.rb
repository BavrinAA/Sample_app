...
class UserMailerTest < ActionMailer::TestCase
  ...
  #     assert_equal [user.email], mail.to
  #     assert_equal ["noreply@example.com"], mail.from
  #     assert_match user.reset_token,        mail.body.encoded,mail.text_part.body.to_s.encode("UTF-8")
  #     assert_match CGI::escape(user.email), mail.body.encoded,mail.text_part.body.to_s.encode("UTF-8")
  #   end
end